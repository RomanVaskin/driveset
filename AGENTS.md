...
Текущий статус: **Этап 1 — MVP-лендинг + посадочная страница оклейки
`/okleyka-avto`; подготовлен единый server-side proxy заявок в OLNOO CRM.**
...
Сложные формы, личный кабинет, онлайн-оплата, другие сложные интеграции.
Исключение: клиентский квиз и один `POST /api/lead` для отправки заявки в
существующую OLNOO CRM. Перед production-запуском сбора контактов нужны
утверждённые Privacy Policy и согласие; юридический текст не придумывать.
