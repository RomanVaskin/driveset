...
Текущий статус: **Этап 1 — визуальный MVP-лендинг + frontend-only посадочная
страница оклейки `/okleyka-avto`.**
...
CRM, сложные формы, личный кабинет, онлайн-оплата, сложные интеграции, backend
для формы. Исключение: согласованный клиентский квиз предварительного расчёта на
`/okleyka-avto`; он не отправляет лид без отдельного подтверждённого API.
