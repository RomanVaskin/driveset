    ...
    <section id="services" className="mx-auto max-w-6xl scroll-mt-20 px-5 py-20 md:py-28 lg:px-8">
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-3">
        {services.map((service) => (
          <article
            key={service.id}
            className="group flex flex-col overflow-hidden rounded-xl border border-border bg-card shadow-soft transition-all hover:border-champagne/40 hover:shadow-card"
          >
            ...
            <div className="flex flex-1 flex-col p-6">
              ...
              <a
                href="#lead"
                className="mt-6 inline-flex items-center gap-1.5 text-sm font-semibold text-champagne transition-opacity hover:opacity-80"
              >
                Записаться
